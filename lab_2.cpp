...
в который передайте подынтегральное выражение в виде функции, верхнюю, нижнюю границу. Сам класс имеет параметры;
число точек, шаг, точность. Строим два производных класса для расчета интегралов методом трапеций и методом Симпсона,
...
int main() {
    ...
    // Выводим результаты
    std::cout << "Интеграл методом трапеций: " << resultTrapezoidal << "\n";
    std::cout << "Интеграл методом Симпсона: " << resultSimpson << "\n";
